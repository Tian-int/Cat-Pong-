...
Original file is located at
    https://colab.research.google.com/drive/1tyy0lrJ2WYhdvGTGd4VwjqHWnu1NGqk-
"""
...
def main():
  ...
  while True:
    ...
    if not started:
      ...
      # We still need to process events for QUIT and SPACE here
      for event in pygame.event.get():
          if event.type == pygame.QUIT:
              pygame.quit()
              return
    ...
    # 🐱 Cat ball position (center of rectangle)
    x = int(ball_rect.x + ball_rect.width / 2)
    y = int(ball_rect.y + ball_rect.height / 2)

    # Face
    pygame.draw.circle(screen, (255, 200, 200), (x, y), 12)

    # Ears
    pygame.draw.polygon(screen, (255, 200, 200), [(x - 10, y - 10), (x - 3, y - 25), (x + 3, y - 10)])
    pygame.draw.polygon(screen, (255, 200, 200), [(x + 10, y - 10), (x + 3, y - 25), (x - 3, y - 10)])

    # Eyes
    pygame.draw.circle(screen, (0, 0, 0), (x - 4, y - 3), 2)
    pygame.draw.circle(screen, (0, 0, 0), (x + 4, y - 3), 2)
